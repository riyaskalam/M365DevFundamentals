...
import * as strings from "ToasterSampleApplicationCustomizerStrings";
import { IToast, ToastService } from "../../services/toastService";
import styles from "./toaster.module.scss";
import { SPComponentLoader } from "@microsoft/sp-loader";
const LOG_SOURCE: string = "ToasterSampleApplicationCustomizer";
import * as $ from "jquery";
import * as toastr from "toastr";

export interface IToasterSampleApplicationCustomizerProperties {
  testMessage: string;
}

export default class ToasterSampleApplicationCustomizer extends BaseApplicationCustomizer<
  IToasterSampleApplicationCustomizerProperties
> {
