...
export interface IFirstTeamsTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IFirstTeamsTabRemoveProps {

}

/**
 * Implementation of FirstTeamsTab remove page
 */
export class FirstTeamsTabRemove  extends TeamsBaseComponent<IFirstTeamsTabRemoveProps, IFirstTeamsTabRemoveState> {
